...
```
https://edu2skill.wordpress.com/course/react-with-vite-custom-css/integrating-express-mongoose-and-nodemon-to-react-application-react-vite-customcss/
```
...
c. when the project will be executed successfully, then console's message written in "index.js" will be displayed in terminal window.
